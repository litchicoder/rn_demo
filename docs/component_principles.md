# 📖 React Native 组件与核心原理

> [!TIP]
> 本质上就是一个**“贴身翻译官”**。用简单轻巧的语言 (JavaScript 和 React) 写下“页面该长什么样”，它负责帮你翻译成 iOS 和 Android 手机真正能懂的“机器语言”，然后呈现给用户。

---

## 1. 什么是“组件” (Component)？—— 像玩乐高
